package au.com.websitemasters.schools.lcps.loader;
...
public class LoaderInserter extends Loader<Bitmap> {
        ...
        for (int i = 0; i < news_jsonArray.length(); i++) {
            try {
                ...
                if (isDelete.equals("0")) {
                    ...
                    //upgrade to empty category
                    upgradeToDeleted("NEWS", serverId);
                }
            } catch (JSONException e) {
                e.printStackTrace();
            }
        ...
        for (int i = 0; i < events_jsonArray.length(); i++) {
            try {
                ...
                if (isDelete.equals("0")) {
                    ...
                    //upgrade to empty category
                    upgradeToDeleted("EVENTS", serverId);
                }
            } catch (JSONException e) {
                e.printStackTrace();
            }
        ...
        for (int i = 0; i < newsletters_jsonArray.length(); i++) {
            try {
                ...
                if (isDelete.equals("0")) {
                    ...
                    //upgrade to empty category
                    upgradeToDeleted("NEWSLETTERS", serverId);
                }
            } catch (JSONException e) {
                e.printStackTrace();
            }
    ...
    public void insertToDBwithUpdade(String category, String was_readed, String date, String title,
        ...
        if (c.moveToFirst() == false) {
            ...
            Log.d("rklogs", "No matches into DB - unical");
    ...
    public void upgradeToDeleted(String category, String serverId) {
        dbHelper = new SQLiteHelper(getContext());
        db = dbHelper.getWritableDatabase();
